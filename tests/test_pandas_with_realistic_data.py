...
car_data = {
    "Brand": ["Toyota", "Honda", "Ford", "BNW", "Audi", "Mercedes", "Tesla",
              "Volkswagen", "Hyundai", "Kia"],
    "Model": ["Camry", "Civic", "Mustang", "X5", "A4", "C-Class", "Model S",
              "Golf", "Elantra", "Sorento"],
...
print(f"Dataframe filter rows:\n{car_sales_data_df[car_sales_data_df['Price'] > 30000]}")

car_sales_data_df.loc[car_sales_data_df['Transmission'] ==
                      'Automatic', 'Transmission'] = 'Semi-Automatic'
