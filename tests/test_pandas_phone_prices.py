...
print(f"DataFrame shows specific rows and columns filter:\n{df_phone_prices.iloc[0:22,0:4]}")

filtered_phones = df_phone_prices[df_phone_prices['clock_speed'] >= 2.4].head(22).iloc[:, 0:4]
print(f"DataFrame shows specific rows and columns filter with condition:\n{filtered_phones}")
